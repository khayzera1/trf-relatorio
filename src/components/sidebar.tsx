...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col bg-card/60 glass-card p-4">
        <div className="flex items-center gap-2 text-foreground mb-8 px-2">
            ...
            {user && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="w-full justify-start items-center gap-2 text-left h-auto p-2">
                ...
                <DropdownMenuContent align="end" side="right" className="w-56 mb-2 glass-card">
