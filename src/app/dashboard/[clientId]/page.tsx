...
import { DollarSign, Eye, MousePointerClick, TrendingUp, User, Tag, ArrowLeft, Target, HandCoins, BadgePercent } from "lucide-react";
...
const campaignDataByCampaignName: { [key: string]: any } = {
    'Google Ads - Pesquisa Local': {
        platform: 'Google Ads',
        kpis: { cost: 'R$1.250,50', clicks: '310', impressions: '8.120', ctr: '3,82%', result: '25 Ligações', cpc: 'R$4,03', costPerResult: 'R$50,02' },
    ...
    'Meta Ads - WhatsApp': {
        platform: 'Meta Ads',
        kpis: { cost: 'R$980,00', clicks: '1.500', impressions: '25.000', ctr: '6,00%', result: '80 Conversas no WhatsApp', cpc: 'R$0,65', costPerResult: 'R$12,25' },
    ...
    'Google Ads - Display': {
        platform: 'Google Ads',
        kpis: { cost: 'R$600,00', clicks: '8.000', impressions: '150.000', ctr: '5,33%', result: 'N/A', cpc: 'R$0,08', costPerResult: 'N/A' },
    ...
    'Meta Ads - Tráfego Site': {
        platform: 'Meta Ads',
        kpis: { cost: 'R$1.800,70', clicks: '450', impressions: '40.000', ctr: '1,13%', result: '1.2k Visitas ao Site', cpc: 'R$4,00', costPerResult: 'R$1,50' },
     ...
     'Google Ads - Pesquisa': {
        platform: 'Google Ads',
        kpis: { cost: 'R$2.500,00', clicks: '400', impressions: '9.500', ctr: '4,21%', result: '50 Agendamentos', cpc: 'R$6,25', costPerResult: 'R$50,00' },
    ...
    'Meta Ads - Catálogo': {
      platform: 'Meta Ads',
      kpis: { cost: 'R$1.500,00', clicks: '2.200', impressions: '60.000', ctr: '3,67%', result: '300 Vendas', cpc: 'R$0,68', costPerResult: 'R$5,00' },
    ...
    'Google Ads - Maps': {
        platform: 'Google Ads',
        kpis: { cost: 'R$450,00', clicks: '150', impressions: '5.000', ctr: '3,00%', result: '40 Rotas Traçadas', cpc: 'R$3,00', costPerResult: 'R$11,25' },
    ...
    'Meta Ads - Leads': {
        platform: 'Meta Ads',
        kpis: { cost: 'R$2.100,00', clicks: '600', impressions: '35.000', ctr: '1,71%', result: '120 Leads', cpc: 'R$3,50', costPerResult: 'R$17,50' },
    ...
    'Google Ads - Rede de Pesquisa': {
        platform: 'Google Ads',
        kpis: { cost: 'R$3.500,00', clicks: '800', impressions: '22.000', ctr: '3,64%', result: '95 Contatos via Site', cpc: 'R$4,38', costPerResult: 'R$36,84' },
    ...
    'Meta Ads - Inscrição': {
        platform: 'Meta Ads',
        kpis: { cost: 'R$1.950,00', clicks: '950', impressions: '48.000', ctr: '1,98%', result: '250 Inscrições', cpc: 'R$2,05', costPerResult: 'R$7,80' },
...
const defaultCampaignData = {
    platform: 'N/A',
    kpis: { cost: 'R$0,00', clicks: '0', impressions: '0', ctr: '0,00%', result: 'Nenhum resultado', cpc: 'R$0,00', costPerResult: 'R$0,00' },
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
                        ...
                        <Card>
                         ...
                         <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">{data.kpis.cpc}</div>
                                <p className="text-xs text-muted-foreground">custo por clique</p>
                            </CardContent>
                        </Card>
                         <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">Custo / Resultado</CardTitle>
                                <BadgePercent className="h-4 w-4 text-muted-foreground" />
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold">{data.kpis.costPerResult}</div>
